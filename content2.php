<?php
	...
	if(isset($page_success)){
		...
		if( $page_success == 1 ){
			...
			// restfullApexCall( $full_object_JSON, $instance_url );
...
<html class="no-js" lang="">
    <head>
        ...
        <link class="user" href="./css/brand.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	*/
    ...
    <input id="eventIDHidden" type="hidden" name="eventIDHidden" alt="hidden field for event id input" title="event ID" />
...
$(document).ready(function() {
	...
	$(document).on("change", ".select-multiple", function() {
		...
		$('#eventIDHidden').val(id_of_selected);
